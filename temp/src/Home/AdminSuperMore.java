...
public class AdminSuperMore {
	...
	@BeforeClass public static void setUpBeforeClass() throws Exception {
		...
		System.out.println("JUnit Test [Admin Super More] started up.\n");
	}
	...
	@AfterClass public static void tearDownAfterClass() throws Exception {
		//Display log of testing process
		System.out.println("JUnit Test [Admin Super More] teardown completed.\n");
	}
	...
	@Test public void testAdminSuperMoreGoToLicensingPage() throws Exception {
	...
	@Test public void testAdminSuperMoreGoToRecordGreetingPage() throws Exception {
		methodName = CommonTestFunction.getMethodName();
		//Display log of testing process
		System.out.println("Start running Test Unit ["+methodName+"]...");
		selenium.click("hdr_dashboard");
