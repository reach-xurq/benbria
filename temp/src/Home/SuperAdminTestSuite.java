...
@SuiteClasses({
	...
	Home.CreateNewPagezoneAdmin.class,
	Home.OrderedSuite.OrderedAdminSuite.class,
	Home.OrderedSuite.OrderedAdminSuperMoreSuite.class,
...
public class SuperAdminTestSuite {
	...
	public static Test suite() {
		return new JUnit4TestAdapter(SuperAdminTestSuite.class);
	}
