/**
 * English.java
 * Description: English language function test.
 * Comments: Used to test the English language swich functions.
...
public class English {
	...
	@BeforeClass public static void setUpBeforeClass() throws Exception {
		...
		System.out.println("JUnit Test [English language] started up.\n");
	...
	@AfterClass public static void tearDownAfterClass() throws Exception {
		//Display log of testing process
		System.out.println("JUnit Test [English language] teardown completed.\n");
	}
